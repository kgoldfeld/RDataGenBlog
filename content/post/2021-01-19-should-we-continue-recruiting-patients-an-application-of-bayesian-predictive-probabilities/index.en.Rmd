...
ggplot(data = test) +
  ...
  theme(panel.grid = element_blank()) +
  scale_color_manual(values =  c("#b72d8a","#8ab72d", "#2d8ab7"), name = "# obs") +
  scale_x_continuous(breaks = seq(0.90, 0.98, by = .01), name = "observed P(OR < 1)") +
  scale_y_continuous(breaks = seq(0.2, 1, by =.2), name = "predicted probability of success")
```
