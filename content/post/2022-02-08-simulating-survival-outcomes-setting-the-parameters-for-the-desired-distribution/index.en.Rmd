...
Of course, we want to actually sample from a distribution defined by these parameters in order to conduct simulations, not just generate and look at deterministic functions. But that remains for another day.
