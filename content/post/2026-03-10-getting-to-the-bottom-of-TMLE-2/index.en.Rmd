---
title: 'Getting to the bottom of TMLE: making the target behave like sampling noise'
author: R Build
date: '2026-03-10'
slug: []
categories: []
...
In the last couple of posts, I’ve tried to unpack some of the ideas that sit underneath TMLE: viewing parameters as functionals of a distribution, thinking about sampling as a perturbation, and understanding how influence functions describe the leading behavior of estimation error. In the second post, I showed through simulation how errors in nuisance estimation can interact with sampling variability — but often only at second order. This brings us to the central idea behind TMLE.
