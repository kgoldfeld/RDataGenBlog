...
We can estimate the RR by using a log-binomial regression model. Like logistic regression, this is implemented using the `glm` function with the binomial "familly", but with a "log" link instead of a "logistic" link:
