...
In the next [post](https://www.rdatagen.net/post/2026-03-10-getting-to-the-bottom-of-tmle-2/), I will look more squarely at TMLE, specifically considering how the targeting step is designed to make the efficient influence function equation hold and to ensure that the remaining discrepancy behaves like sampling noise rather than model-driven bias.
